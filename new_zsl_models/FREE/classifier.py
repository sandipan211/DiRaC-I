...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, netFR=None, dec_size=4096, dec_hidden_size=4096, generalized=True, testing=False, opt=None):
