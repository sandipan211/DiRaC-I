...
class ALE():
	...
	def zsl_acc_gzsl(self, X, W, y_true, classes, sig, testing = False, unseen = False): # Class Averaged Top-1 Accuarcy
		...
		print(X.shape, W.shape, y_true.shape, classes.shape, sig.shape)
...
if __name__ == '__main__':
	...
	gzsl_folder = '/home/gdata/sandipan/BTP2021/new_zsl_models/ALE/GZSL_al_lr' + str(args.al_lr) + '/' 
